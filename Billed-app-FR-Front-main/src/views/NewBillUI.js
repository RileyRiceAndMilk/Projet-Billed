    ...
    <div class='layout'>
      ...
      <div class='content'>
        ...
        <div class="form-newbill-container content-inner">
          <form data-testid="form-new-bill" onsubmit="{this.handleSubmit}">
            <div class="row">
                <div class="col-md-6">
                  <div class="col-half">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                   <label for="file" class="bold-label">Justificatif</label>
                    <input required type="file" id="file" class="form-control blue-border error-message" data-testid="file" />
                    <div class="error-message" style="color: red;"></div> <!-- Zone pour afficher l'erreur -->
                     <div class="file-name"></div> <!-- Zone pour afficher le nom du fichier sélectionné -->
                  </div>
